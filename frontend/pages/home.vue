<template>
    <div>
        <div class="flex flex-col vvsm:p-6 lg:p-24 xl:p-24 lxl:flex-row h-full place-items-center justify-center gap-16">
            <!-- Image Section -->
            <div class="md:flex md:overflow-hidden hover:shadow-lg hover:shadow-[#e7a93c] hover:rounded-xl dark:hover:shadow-[#0ee2b7] hover:duration-1000">
                <NuxtLink to="/">
                    <img src="../assets/images/team.jpg" class="w-full vvsm:rounded-lg md:rounded-xl" alt="Team Image">
                </NuxtLink>
            </div>
            <!-- Text Section -->
            <div class="lxl:w-1/2">
        ...
        <div class="text-2xl dark:text-white text-black p-16">   
            <span>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ea aliquam cupiditate doloremque eos harum eum autem non dolor voluptates amet officiis, quaerat tempore illum dignissimos ratione voluptatum voluptate illo aliquid.</span>
        </div>
        <div class="text-2xl dark:text-white text-black p-16">   
            <span>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ea aliquam cupiditate doloremque eos harum eum autem non dolor voluptates amet officiis, quaerat tempore illum dignissimos ratione voluptatum voluptate illo aliquid.</span>
        </div>
        <!---Footer-->
        <div class="flex relative dark:text-white justify-center text-2xl font-inter gap gap-1">
